...
class GeracaoEfin(View):
    ...
    def gerar_semestre(self, investidor , fundos_dtvm):
        ...
        try:
            ...
            self.gerar_arquivo_efin(datetime(2024, 2, 29), investidor, fundos_dtvm)
            self.gerar_arquivo_efin(datetime(2024,3,31) , investidor ,  fundos_dtvm)
            ...
            client_mongo['logs']['gerar_arquivo'].insert_one({'message':'inserção gerar arquivos'})
        except Exception as e:
            client_mongo['logs']['gerar_arquivo'].insert_one({'message':str(e)})
