...
class o2Api():
    ...
    def valor_cota_adicionar(self, df_cotas):
        ...
        cotas = [{"data": item['data'],
                  "valor": item['cota'],
                  "descricaoCodigoInstrumentoFinanceiro": item['cd_escritural']
    ...
    def get_emissores(self):
        ...
        url = "https://escriturador.oliveiratrust.com.br/intactus/icorp/api/emissor/obtertodos"

        resultado = requests.get(url , headers=headers)



        df = pd.DataFrame.from_dict(resultado.json()['dados'])
